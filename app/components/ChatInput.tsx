...
function ChatInput() {
  return (
    <div className="p-4 bg-white border-t border-gray-300 flex w-full gap-4">
      ...
      <button className="bg-purple-500 text-white px-6 py-2 rounded-full font-semibold cursor-pointer hover:bg-purple-600 transition-colors disabled:opacity-50 disabled:hover:cursor-not-allowed h-fit self-end">
        Send Message
      </button>
    </div>
  );
